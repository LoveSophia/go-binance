...
type topTraderLongShortRatioServiceTestSuite struct {
	baseTestSuite
}

func TestTopTraderLongShortRatioService(t *testing.T) {
	suite.Run(t, new(topTraderLongShortRatioServiceTestSuite))
}

func (s *topTraderLongShortRatioServiceTestSuite) TestTopTraderLongShortRatioService() {
	data := []byte(`[
		{ 
			"symbol":"BTCUSDT",
...
func (s *topTraderLongShortRatioServiceTestSuite) assertLongShortRatioEqual(e, a *LongShortRatio) {
	r := s.r()
